...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    footer_address: '123 Dharma Lane, Spirituality City, SC 12345, India',
    ...
    page_title_blog: 'Vivekananda Awakening Foundation Blog - Vivekananda Awakening Foundation',
    ...
    home_welcome_tagline: 'उत्तिष्ठत जाग्रत प्राप्य वरान्निबोधत', // Keep as is
  ...
  hi: {
    ...
    // Footer
    footer_description: 'विवेकानन्द जागरण फाउंडेशन — समग्र कल्याण के लिए विज्ञान और आध्यात्मिकता को जोड़ना।',
    footer_quick_links: 'त्वरित लिंक्स',
    footer_connect_with_us: 'हमसे जुड़ें',
    footer_address: '१२३ धर्म लेन, आध्यात्मिकता शहर, एससी १२३४५, भारत',
    footer_email_prompt: 'ईमेल:',
    footer_copyright: '© {year} विवेकानन्द जागरण फाउंडेशन — एक गैर-लाभकारी संगठन।',
    footer_sitemap: 'साइटमैप',
    footer_admin: 'एडमिन',

    // Page Titles
    page_title_default: 'विवेकानन्द जागरण फाउंडेशन',
    page_title_home: 'विवेकानन्द जागरण फाउंडेशन',
    page_title_about: 'हमारे बारे में - विवेकानन्द जागरण फाउंडेशन',
    page_title_programs: 'हमारे कार्यक्रम - विवेकानन्द जागरण फाउंडेशन',
    page_title_mythology_meditation: 'पौराणिक कथाएं और ध्यान संसाधन - विवेकानन्द जागरण फाउंडेशन',
    page_title_blog: 'विवेकानन्द जागरण फाउंडेशन ब्लॉग - विवेकानन्द जागरण फाउंडेशन',
    page_title_blog_post: '{postTitle} - ब्लॉग - विवेकानन्द जागरण फाउंडेशन',
    page_title_ai_guide: 'एआई आध्यात्मिक परामर्शदाता व्यास - विवेकानन्द जागरण फाउंडेशन',
    page_title_sitemap: 'साइटमैप - विवेकानन्द जागरण फाउंडेशन',
    ...
    // About Page
    about_hero_title: 'विवेकानन्द जागरण फाउंडेशन के बारे में',
    ...
    // Programs Page (using English as placeholder for Hindi)
    ...
    // Mythology & Meditation Page (Resources - using English as placeholder for Hindi)
    ...
    blog_hero_title: "विवेकानन्द जागरण फाउंडेशन ब्लॉग",
    ...
    // AI Guide Page (using English as placeholder for Hindi)
